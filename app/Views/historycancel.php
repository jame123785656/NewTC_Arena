...
<body>
    ...
    <div class="box-table">
        <h1>ประวัติการจองยกเลิก</h1>

        <?php if ($user) : ?>
        <h4>สถานะ  
        <button type="button" class="btnEdit"><a href="/userhistory/<?php echo $user['ID'] ?>">ทั้งหมด</a></button>
        ...
        <button type="button" class="btnEdit" Disabled>ยกเลิก</button>  
                ...
                <?php if ($booking) : ?>
                    <?php foreach ($booking as $bookings) : ?>
                        <tr>
                            ...
                            <div class="colorhis">
                                <td class=<?php if ($bookings['B_status'] === '4') {
                                                echo 'red';
