...
$routes->get('/pay_delete/(:any)', 'Pay::pay_delete/$1');
...
$routes->get('/historycancel/(:num)', 'Historyadmin::historycancel/$1',['filter' => 'auth']);
$routes->get('/historysucceed/(:num)', 'Historyadmin::historysucceed/$1',['filter' => 'auth']);
$routes->get('/historypending/(:num)', 'Historyadmin::historypending/$1',['filter' => 'auth']);
$routes->get('/cancel_booking/(:any)', 'userhistory::cancel_booking/$1');
$routes->get('/userhistory_delete/(:any)', 'userhistory::userhistory_delete/$1');
