...
$routes->get('/historycancel/(:num)', 'Userhistory::historycancel/$1',['filter' => 'auth']);
$routes->get('/historysucceed/(:num)', 'Userhistory::historysucceed/$1',['filter' => 'auth']);
$routes->get('/historypending/(:num)', 'Userhistory::historypending/$1',['filter' => 'auth']);
